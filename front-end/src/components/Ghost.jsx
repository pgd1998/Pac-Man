...
//                 if (blinkyPosition) {
//                     targetPos = {
//                         x: pacmanPosition.x + (pacmanPosition.x - blinkyPosition.x),
//                         y: pacmanPosition.y + (pacmanPosition.y - blinkyPosition.y)
//                     };
//                 } else {
//                     targetPos = pacmanPosition;
//                 }
...
//             case 'clyde':
//                 // Shy behavior
//                 const distanceToPacman = calculateDistance(position, pacmanPosition);
